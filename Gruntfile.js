// Generated on 2016-01-19 using generator-angular-fullstack 3.3.0-beta.0
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    ngconstant: {
      options: {
        name: 'hostelManagerApp.constants',
    ...
    buildcontrol: {
      ...
      heroku: {
        options: {
          remote: 'git@heroku.com:hostel-manager.git',
          branch: 'master'
        }
      },
      openshift: {
